...
/**
 * Servlet implementation class RemovePackage
 */
@WebServlet("/RemovePackage")
public class RemovePackage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String price = request.getParameter("code");
		...
		try {
			...
			st.executeUpdate("delete from food_packages where package_price = ('"+price+"')");
