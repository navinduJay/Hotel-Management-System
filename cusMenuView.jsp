...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
      <h2>Our Menu</h2> <h4>To enjoy the glow of good health, you must exercise</h4>
    </div>
        </div>
        ...
        <div class="col-md-4">
          ...
          <p style="text-align:center; margin-top:20px;">
            <img src="img/food123.jpg"  class="img-responsive" alt="">
          </p>
          <div class="caption">
            <div class="blur"></div>
            <div class="caption-text">
              <h3 style="border-top:2px solid white; border-bottom:2px solid white; padding:10px;"><span class="glyphicon glyphicon-cutlery"></h3>
              <h2>Regular Menu</h2>
              <a href="regularMenuCustomer.jsp" class="btn btn-success" role="button">more info</a>
                 ...
                 <div class="col-md-4">
                   <div class="cuadro_intro_hover " style="background-color:#cccccc;">
                   <p style="text-align:center; margin-top:20px;">
                     <img src="img/regular.jpg"  class="img-responsive" alt="">
                   </p>
                   <div class="caption">
                     <div class="blur"></div>
                     <div class="caption-text">
