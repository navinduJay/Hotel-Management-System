...
@WebServlet("/Increments")
public class Increments extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			st.executeUpdate("insert into transactions(nic,basic,i_amount,i_date) values('"+id+"','"+basic+"','"+amount+"','"+date+"')");
